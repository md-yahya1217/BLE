...
#define analogue 1 //connect the potentiometer to gpio36
...
void setup() {
  ...
  VariableDescriptor.setValue("Sensor Value");          /* Use this format to add a hint for the user. This is optional. */
...
void loop() {
  sensorRead = analogRead(analogue);  //read the value of the potentiometer
